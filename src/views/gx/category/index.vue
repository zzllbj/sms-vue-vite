...
const options = reactive({
  ...
  edit: {
    show: true,
    auth: ['/gx/ArticleCategory/update'],
    func: async (record) => {
  ...
  delete: {
    show: true,
    auth: ['/gx/ArticleCategory/destroy'],
    func: async (params) => {
    ...
    realAuth: ['/gx/ArticleCategory/realDestroy'],
  ...
  recovery: {
    show: true,
    auth: ['/gx/ArticleCategory/recovery'],
    func: async (params) => {
