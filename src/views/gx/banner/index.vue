...
const options = reactive({
  ...
  delete: {
    ...
    realAuth: ['/gx/ArticleBanner/realDestroy'],
  ...
  recovery: {
    show: true,
    auth: ['/gx/ArticleBanner/recovery'],
    func: async (params) => {
